...
def drawOnImage(img, radius, AvgSentiment, key):
	img = cv2.circle(img,(x,y), radius, (120, 127.5+(AvgSentiment*127.5), 127.5+(AvgSentiment*-127.5)), -1)
...
url=urllib.request.urlopen("https://trends.google.com/trends/hottrends/atom/feed?pn=p1").read().decode("utf-8")
